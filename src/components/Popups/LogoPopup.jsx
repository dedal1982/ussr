  ...
  return (
    <>
      ...
      <ul className="popup-list">
        <li>
          <strong>Название компании:</strong> ООО «Честный Эйб»
        </li>
        <li>
          <strong>Деятельность:</strong> разработка игр
        </li>
        <li>
          <strong>Философия:</strong> создание честных, увлекательных и
          качественных игр, которые будут радовать игроков.
        </li>
        <li>
          <strong>Планы на будущее:</strong> после выхода первой игры компания
