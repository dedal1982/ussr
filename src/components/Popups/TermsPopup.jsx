...
export const TermsPopup = () => {
  return (
    <>
      ...
      <h2 className="popup-title">Пользовательское соглашение</h2>
      ...
      <ol className="popup-list">
        <li>
          <strong>Правила использования сайта:</strong>
          <p>
        ...
        <li>
          <strong>Согласие с правилами:</strong>
          <p>
