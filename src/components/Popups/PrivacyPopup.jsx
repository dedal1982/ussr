...
export const PrivacyPopup = () => {
  return (
    <>
      ...
      <h2 className="popup-title">Политика конфиденциальности</h2>
      <ol className="popup-list">
        <li>
          ...
          <ul className="popup-list-nested">
            ...
            <li>
              <strong>Cookie-файлы</strong>: мы используем cookie для улучшения
        ...
        <li>
          <strong>Кому мы передаём данные?</strong>
          <p>
        ...
        <li>
          <strong>Изменения в политике:</strong>
          <p>
